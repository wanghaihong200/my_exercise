 ...
 * 在进行json数据序列化及反序列化时, LocalDateTime、
...
public class JacksonObjectMapper extends ObjectMapper {
    ...
    public JacksonObjectMapper() {
        ...
        SimpleModule simpleModule = new SimpleModule()
                ...
                .addSerializer(BigInteger.class, ToStringSerializer.instance)  // java->json, BigInteger ->String
                .addSerializer(Long.class, ToStringSerializer.instance)  // java->json, Long ->String
